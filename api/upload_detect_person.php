...
if ($userid && $_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES['detect_person_img'])) {
    ...
    if (move_uploaded_file($file["tmp_name"], $targetFilePath)) {
        ...
        /* ===================== CALL PYTHON API ===================== */
         ...
         $pythonApiUrl = "http://195.35.7.83:5048/detectface";
        ...
        if ($httpCode == 200) {
            ...
            logAction($con, $userid, $username, "Face detected successfully", "Success", $current_datetime);
            ...
            $errorMsg = substr($curlResponse, 0, 500);
            $errorMsg = mysqli_real_escape_string($con, $errorMsg);

            logAction($con, $userid, $username, "Face detection failed: ".$errorMsg, "Failed", $current_datetime);
